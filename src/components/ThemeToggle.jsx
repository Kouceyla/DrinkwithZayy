...
function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      type="button"
      className="flex items-center gap-2 bg-foreground/10 border border-foreground/20 rounded-full px-4 py-2 text-foreground text-sm font-semibold hover:bg-foreground/20 transition-all"
